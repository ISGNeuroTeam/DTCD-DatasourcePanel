...
```
tar -zxf DTCD-DatasourcePanel-*.tar.gz ./DTCD-DatasourcePanel
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/ISGNeuroTeam/DTCD-DatasourcePanel/tags).
